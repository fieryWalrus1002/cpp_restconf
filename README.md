...
- Replace all occurrences of "Devquery" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Devquery` means the name of the project, while `devquery` is used in file names.
  - Remember to rename the `include/devquery` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
...
./build/standalone/Devquery --help
```
